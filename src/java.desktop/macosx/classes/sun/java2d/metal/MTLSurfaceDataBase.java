...
import static sun.java2d.metal.MTLContext.MTLContextCaps.*;
import static sun.java2d.pipe.BufferedOpCodes.*;

/**
 * This class describes an OpenGL "surface", that is, a region of pixels
 * managed via OpenGL.  An MTLSurfaceDataBase can be tagged with one of three
...
public abstract class MTLSurfaceDataBase extends SurfaceData
    ...
    private MTLGraphicsConfigBase graphicsConfig;
    protected int type;
    ...
    protected MTLSurfaceDataBase(MTLGraphicsConfigBase gc,
     ...
     * this surface.
     *
     * Specifically, for {@code MTLSurfaceDataBase} this method returns the
     * the following:
     * <pre>
     * TEXTURE              - texture id
     * </pre>
    ...
    /**
     * Disposes the native resources associated with the given MTLSurfaceDataBase
     * (referenced by the pData parameter).  This method is invoked from
     * the native Dispose() method from the Disposer thread when the
     * Java-level MTLSurfaceDataBase object is about to go away.  Note that we
